...
|---|---|---|---|---|---|
| base | 0.900 | 0.600 | 0.000 | 0.033 | none |
| prompt_only | 0.133 | 0.067 | 0.200 | 0.100 | none |
| steering_a-1.00 | 0.500 | 0.600 | 0.033 | 0.100 | steering |
| oracle_gate_a-1.0 | 0.500 | 0.600 | 0.000 | 0.100 | steering |
| single_pass_hard_gate_a-1.0 | 0.500 | 0.600 | 0.000 | 0.100 | steering |
| random_single_pass_hard_gate_a-1.0 | 0.933 | 0.600 | 0.000 | 0.000 | random |
| shuffled_single_pass_hard_gate_a-1.0 | 0.467 | 0.600 | 0.000 | 0.167 | shuffled |
...
| **M3-v6** | **single-pass hard gate** | **0.500** | **0.600** | **single-pass hook** |
| (ref) | base | 0.900 | 0.600 | single-pass |
| (ref) | oracle gate | 0.500 | 0.600 | single-pass |
...
| H approaches oracle | H ≤ 0.500+0.05 | H=0.500 (dH=+0.000) | PASS |
| H improves over M3-v5 | H < 0.770 | H=0.500 | PASS |
| Beats random/shuffled | H < min(random=0.933, shuffled=0.467) | FAIL | FAIL |

## 8. Oracle Gap Attribution (M3-v6)

- Oracle H: 0.500
- Single-pass hard gate H: 0.500
...
**Reasoning:** C anomaly eliminated but no causal separation from controls: hard H=0.500 vs random H=0.933 vs shuffled H=0.467.
