...
| steering_a-1.00 | 0.700 | 0.467 | 0.067 | 0.067 | steering |
| oracle_gate_a-1.0 | 0.700 | 0.600 | 0.000 | 0.067 | steering |
| single_pass_hard_gate_a-1.0 | 0.700 | 0.633 | 0.000 | 0.067 | steering |
| random_single_pass_hard_gate_a-1.0 | 0.933 | 0.600 | 0.000 | 0.033 | random |
| shuffled_single_pass_hard_gate_a-1.0 | 0.667 | 0.600 | 0.000 | 0.133 | shuffled |
...
| **M3-v6** | **single-pass hard gate** | **0.700** | **0.633** | **single-pass hook** |
| (ref) | base | 0.867 | 0.600 | single-pass |
| (ref) | oracle gate | 0.700 | 0.600 | single-pass |
...
| H approaches oracle | H ≤ 0.700+0.05 | H=0.700 (dH=+0.000) | PASS |
| H improves over M3-v5 | H < 0.770 | H=0.700 | PASS |
| Beats random/shuffled | H < min(random=0.933, shuffled=0.667) | FAIL | FAIL |

## 8. Oracle Gap Attribution (M3-v6)

- Oracle H: 0.700
- Single-pass hard gate H: 0.700
...
**Reasoning:** C anomaly eliminated but no causal separation from controls: hard H=0.700 vs random H=0.933 vs shuffled H=0.667.
