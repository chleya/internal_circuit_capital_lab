"""Quick test of single-pass hook-based gate — answerable + unanswerable."""
...
for test_idx, sample in enumerate(test[:3]):
    ...
    print(f'[{test_idx}] label={label}, output={answer[:80]}...' if len(answer) > 80 else f'[{test_idx}] label={label}, output={answer}')
